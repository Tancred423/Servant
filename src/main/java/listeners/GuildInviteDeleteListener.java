...
public class GuildInviteDeleteListener extends ListenerAdapter {
    public void onGuildInviteDelete(@Nonnull GuildInviteDeleteEvent event) {
        ...
        CompletableFuture.runAsync(() -> {
            // Log
            if (myGuild.pluginIsEnabled("log") && myGuild.categoryIsEnabled("moderation") && myGuild.logIsEnabled("invite_delete")) {
                ...
                if (logChannel != null) {
                    logChannel.sendMessage(new EmbedBuilder()
                            ...
                            .setTitle(LanguageHandler.get(lang, "log_invite_delete_title"))
