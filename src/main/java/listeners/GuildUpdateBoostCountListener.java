...
public class GuildUpdateBoostCountListener extends ListenerAdapter {
    ...
    public void onGuildUpdateBoostCount(@Nonnull GuildUpdateBoostCountEvent event) {
        ...
        CompletableFuture.runAsync(() -> {
            // Log
            if (myGuild.pluginIsEnabled("log") && myGuild.categoryIsEnabled("moderation") && myGuild.logIsEnabled("boost_count")) {
                ...
                if (logChannel != null) {
                    logChannel.sendMessage(new EmbedBuilder()
                            ...
                            .setTitle(LanguageHandler.get(lang, "log_boost_count_title"))
                            .addField(LanguageHandler.get(lang, "log_new_boost_count"), String.valueOf(event.getNewBoostCount()), true)
                            .addField(LanguageHandler.get(lang, "log_old_boost_count"), String.valueOf(event.getOldBoostCount()), true)
